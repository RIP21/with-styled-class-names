...
var _initialiseProps = function _initialiseProps() {
  ...
  this.generateStylesLifters = function (stylesMap) {
    var StylesLifters = [];
    Object.entries(stylesMap).forEach(function (entry) {
      ...
      if (isStyledComponent(value)) {
        ...
        Object.entries(value).forEach(function (style) {
          return isStyledComponent(style[1]) ? StylesLifters.push(_this3.createStyleWithSC(style[1], style[0], customClassNameProp)) : StylesLifters.push(_this3.createStyleWithTag(style[1], style[0], customClassNameProp));
        });
      } else {
  ...
  this.renderStyles = function () {
    return _this3.Styles.map(function (SC) {
      return _react2.default.createElement(SC, _this3.props);
    });
  };
